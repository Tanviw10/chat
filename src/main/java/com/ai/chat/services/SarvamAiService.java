...
public class SarvamAiService {
	...
	public String askSarvam(List<ChatMessage> history ,String userMessage) {
		...
		message.add(Map.of("role","system","content","You are a helpful AI Assistant."));
		
		for (ChatMessage msg: history) {
			message.add(Map.of("role",msg.getRole(),"content",msg.getContent()));
		}
		
		message.add(Map.of("role","user","content",userMessage));
